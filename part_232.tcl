...
CONFIG.C_TRIGOUT_EN {true} \
  ...
  set_property -dict [ list \
CONFIG.PCW_FTM_CTI_IN0 {BOTH} \
CONFIG.PCW_FTM_CTI_OUT0 {BOTH} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
